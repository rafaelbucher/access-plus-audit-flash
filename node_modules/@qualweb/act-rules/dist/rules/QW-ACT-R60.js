...
class QW_ACT_R60 extends AtomicRule_object_1.AtomicRule {
    execute(element) {
        ...
        const test = new evaluation_1.Test(evaluation_1.Verdict.WARNING);
...
], QW_ACT_R60.prototype, "execute", null);
