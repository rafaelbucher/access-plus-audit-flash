...
class QW_WCAG_T4 extends Technique_object_1.Technique {
    execute(element) {
        ...
        else if (summary.trim() === (caption === null || caption === void 0 ? void 0 : caption.trim())) {
            test.verdict = evaluation_1.Verdict.FAILED;
            test.resultCode = 'F2';
        }
        else {
...
exports.QW_WCAG_T4 = QW_WCAG_T4;
__decorate([
    applicability_1.ElementExists,
    applicability_1.ElementIsDataTable,
    (0, applicability_1.ElementHasAttribute)('summary'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Function]),
    __metadata("design:returntype", void 0)
], QW_WCAG_T4.prototype, "execute", null);
